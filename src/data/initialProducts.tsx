...
export const initialProducts: Product[] = [
  ...
  },
  {
    ...
    harga: 18000,
    urlGambar: "https://www.sariroti.com/storage/app/media/03-product/rotitawar/roti_sobek_cokelat3_.jpg",
    deskripsi: "Roti sobek lembut dengan isi Cokelat Blast dari Sari Roti. Yummy, mengenyangkan, dan bisa juga untuk berbagi dengan teman dan keluarga.",
    kategori: "Makanan",
    rating: 4.3,
    terjual: 156
  },
  {
    ...
    nama: "HappyTos",
    harga: 15000,
    urlGambar: "https://www.yoline.co.id/media/products/ProductMerahcoffehappytosmerah_happytos_gr.png",
    deskripsi: "Happy Tos Merah 160g merupakan keripik renyah nan lezat yang terbuat dari biji jagung pilihan.",
    kategori: "Makanan",
    rating: 4.5,
    terjual: 302
  },
  {
    id:17,
    nama: "BengBeng Share It",
    harga: 16500,
    urlGambar: "https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//98/MTA-16833491/beng-beng_beng_beng_-_share_it_full01_kusjnpw9.jpg",
    deskripsi: "camilan wafer cokelat berukuran mini dengan lapisan karamel, rice crispy yang renyah, dan wafer lembut yang dibalut cokelat susu.",
    kategori: "Makanan",
    rating: 4.6,
    terjual: 433
  },
  {
    id: 18,
    nama: "Tango Wafer Long Coklat",
    harga: 6000,
    urlGambar: "https://www.static-src.com/wcsstore/Indraprastha/images/catalog/medium//97/MTA-52290095/tango_tango_wafer_long_coklat_1_dus_isi_24_pcs_-120_gr-pcs_full01_ieh93pkk.jpg",
    deskripsi: "Wafer Tango Long Coklat 120g merupakan wafer renyah lezat dengan isian coklat. Wafernya terdiri dari beberapa lapis, dengan isian coklat yang lembut dan meleleh di mulut.",
    kategori: "Makanan",
    rating: 4.5,
    terjual: 350
  },
  {
    ...
    nama: "Twister",
    harga: 9000,
    urlGambar: "https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//94/MTA-24552175/twister_twister-minis-black-vanila-80-gr-_full01.jpg",
    deskripsi: "Cemilan merupakan makanan ringan yang digemari oleh banyak orang, rasa lezat dan gurih membuat masyarakat tidak bisa meninggalkan cemilan.",
    kategori: "Makanan",
    rating: 4.5,
    terjual: 388
  },
